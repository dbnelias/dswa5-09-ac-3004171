...
var cursos = [
    { _id: 1, curso: 'Engenharia de Produção', coordenador: 'eng.pro@ifsp.edu.br' },
    { _id: 2, curso: 'Tecnologia em Análise e Desenvolvimento de Sistemas', coordenador: 'tec.ana@ifsp.edu.br' },
    { _id: 3, curso: 'Licenciatura em Letras Português/Inglês', coordenador: 'lic.let@ifsp.edu.br' },
    { _id: 4, curso: 'Tecnologia em Gestão Pública', coordenador: 'tec.ges@ifsp.edu.br' }
]
